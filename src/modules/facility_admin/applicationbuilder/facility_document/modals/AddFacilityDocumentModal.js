...
const AddFacilityDocumentModal = (props) => {
  ...
  useEffect(() => {
    template["type"] = "Facility Document";
    setValues(template);
  }, [template]);
          ...
          <Modal.Header style={{ background: "#F7F7F7" }}>
            <Modal.Title id="contained-modal-title-vcenter">
              {props && props?.show && props?.show > 0
                ? "Edit Facility Document Template"
                : "Add Facility Document Template"}
            </Modal.Title>
...
export default AddFacilityDocumentModal;
